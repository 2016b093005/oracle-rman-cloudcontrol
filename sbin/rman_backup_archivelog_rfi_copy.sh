#!/usr/bin/env bash
# ------------------------------------------------------------------------------------------------------------
# ----  Script Name: rman_backup_archivelog_rfi_copy.sh 
# ----  Versioninformation
...
# RMAN Call
echo "rman cmdfile=${RMAN_SCRIPT_BASE_PATH}/rman_backup_archivelog_rfi_copy.rcv $ORACLE_SID \"$BACKUP_DIR\" "
rman cmdfile=${RMAN_SCRIPT_BASE_PATH}/rman_backup_archivelog_rfi_copy.rcv $ORACLE_SID \"$BACKUP_DIR\"
